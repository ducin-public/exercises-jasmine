...
describe('async functions', () => {
	...
	describe('sequential vs concurrent', () => {
		...
		async function fetchEmployees__sequential(){
			// async function body
		}

		it('should perform asynchronous calls sequentially', async () => {
		...
		async function fetchEmployees__sequentialForLoop(...ids){
			let result = [];
			for (let id of ids) {
		...
		it('should perform asynchronous calls sequentially using for..of loop', async () => {
			fetchEmployees__sequentialForLoop(id1, id2, id3, id4 /* put IDs here */)
				.then(([e1, e2, e3, e4]) => {
					expect(e1.salary).toBe(7191)
					expect(e2.salary).toBe(5941)
					expect(e3.salary).toBe(4157)
		...
		async function fetchEmployees__concurrent(){
			// async function body
		}

		it('should perform asynchronous calls concurrently', async () => {
