import { Account, Employee, Department, Geo, Project, Office, Benefit, Todo, Transaction, Nationality } from './types'
export * from './types'

const accounts: Account[] = require('../db/accounts.json')
...
const getAccounts = () => data.accounts;
